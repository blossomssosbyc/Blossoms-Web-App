      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center text-white z-10">
          ...
          <p className="text-lg md:text-xl mb-8 text-white/80">
            School of Sciences Annual Event
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <EventCard
              ...
              description="24-hour hackathon featuring AI and ML challenges with industry mentors."
            ...
            <EventCard
              ...
              description="Showcase of innovative projects from all departments with live demonstrations."
              date="March 22, 2024"
