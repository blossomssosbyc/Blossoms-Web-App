...
export default function AdminRegister() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    // Dummy Auth Check
    if (username === "Blossoms2025" && password === "Blossoms@SOS2025") {
      setTimeout(() => {
        setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden flex items-center justify-center py-12">
      ...
      <div
        className="absolute bottom-20 right-20 w-96 h-96 bg-pink-500 rounded-full blur-3xl opacity-10 animate-pulse"
        style={{ animationDelay: "1s" }}
      />

      <div
        ref={containerRef}
        className="max-w-lg w-full px-4 sm:px-6 relative z-10"
      >
        <div className="rounded-2xl border border-purple-500/20 bg-gradient-to-br from-black via-purple-900/10 to-black backdrop-blur-md p-8 shadow-2xl shadow-purple-900/20">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-400">
              {isSignIn ? "Sign in to dashboard" : "Register for admin features"}
            </p>
          </div>
            ...
            <div className="space-y-6 text-center">
              ...
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  Your account is now verified. Awaiting admin approval...
                </p>
              </div>
